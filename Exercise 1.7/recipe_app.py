...
class Recipe(Base):
    ...
    # Define columns attributes for each column in your table 
...
class Menu(Recipe):
    ...
    def search_by_ingredients(self):
        ...
        try:
            ingredient_indexes = input("Enter the numbers of the ingredient you would like to search for (space-separated): ").split(" ")
            search_ingredients = []
